...
public class Library {
    ...
    public void registerMember(LibraryMember member) { members.add(member); }
...
/* 
 - Static Nested Class (Book) represents books shared across all library instances.

 - Inner Class (LibraryMember) represents members tied to a specific library instance.

 - Static members (books list) are shared among all Library instances.

 - Encapsulation ensures book borrowing/returning is managed safely.
*/
